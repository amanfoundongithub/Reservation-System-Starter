...
import flight.reservation.plane.Factory.PassengerPlane.AntonovAN2Factory;
...
public class ScheduleTest {
    ...
    class GivenAnEmptySchedule {
        ...
        class WhenAFlightIsScheduled {
            ...
            void scheduleOneFlight() {
                ...
                AeroInterface aircraft = (new A380Factory()).createPlane();
    ...
    class GivenAnExistingSchedule {
        ...
        List<Flight> flights = Arrays.asList(
                new Flight(1, airports.get(0), airports.get(1), (new A350Factory()).createPlane()),
                new Flight(2, airports.get(1), airports.get(2), (new A380Factory()).createPlane()),
                new Flight(3, airports.get(2), airports.get(4), (new Embraer190Factory()).createPlane()),
                new Flight(4, airports.get(3), airports.get(2), (new AntonovAN2Factory()).createPlane()),
                new Flight(5, airports.get(4), airports.get(2), (new H1Factory()).createPlane()),
                new Flight(6, airports.get(5), airports.get(7), (new HypaHypeFactory()).createPlane())
        );
